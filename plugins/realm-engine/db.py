...
INSERT OR IGNORE INTO codex_entries VALUES ('node-workstation', 'nodes', 'The Citadel', 'Primary Workstation', 'The Watcher''s seat of power — where Claude Code runs, where the realm is commanded', 'Katana is the Watcher''s throne — a powerful workstation running Ubuntu desktop with NVIDIA GPU. All realm management happens here: Claude Code sessions, realmwatch map server, MCP game servers, and the Realm HUD. It is both the command center and the primary development machine.', 'katana (10.0.6.110): Ubuntu 24.04, Intel i7, 16GB RAM, NVIDIA GPU. Runs: realmwatch (HTTP :80), 5 MCP game servers, gnome-speaks, realm-optimizer. GNOME desktop with Realm Shell theme, HUD extension, Spellbook panel. PipeWire audio. Collectd agent reports to self.', 1);
