...
const BRANCHES = {
  'master': {
    icon: '\u2694\uFE0F',
    name: 'The Realm',
    desc: 'All features merged &mdash; plugin system, WinBox WM, desktop themes, and full network map.',
    features: [
      'Plugin system with 14+ extractable modules',
      'WinBox.js floating window manager',
      'Dark/light Gem Treasury desktop themes',
      'AP scanner with MAC-rotation merge',
      'Live collectd metrics &amp; SSE streaming',
      'LLDP ethernet topology detection',
    ],
    tags: {},
  },
};
