...
def scan_and_update():
    ...
    # --- Auto-creation of _unknown_* topology nodes: DISABLED ---
    # WiFi/wired clients are now discovered as SubEntities via the discovery
    # system (plugins/wifi/). Unknown devices appear in the Vassals tab instead
    # of cluttering the map with transient auto-nodes.
    # The 'unknown' list above is still populated for the wifi discovery provider.
    auto_added = 0
    wired_added = 0
    auto_merged = 0
    enriched_count = 0
